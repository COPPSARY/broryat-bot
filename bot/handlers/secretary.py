...
async def handle_business_connection(
    ...
    if user_pref_repo is not None:
        await user_pref_repo.set_username(connection.user.id, connection.user.username)
        await user_pref_repo.set_name(
            connection.user.id, connection.user.first_name, connection.user.last_name
        )
...
async def handle_secretary_message(
    ...
    await context.bot.send_message(
        ...
        text=format_vt_alert(result, language, ask_to_delete=True),
